...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    /// - Note:
    /// Defaults to 30.
    open var optionSelectorPanelOffsetHighlightMonth: CGFloat = 18
    ...
    open var optionSelectorPanelScaleMonth: CGFloat = 2
    open var optionSelectorPanelScaleDate: CGFloat = 2
